...
lemma cf_missing_insert_virtual_cut:
  ...
  unfolding cf.virtual_cut_def core_virtual_cut_state_def
...
proof
  ...
  hence "restrict (Apply (l4f_clean_prefix CClaimRefresh)) (l4f_scope CClaimRefresh)
    ...
    unfolding cf.virtual_cut_def core_virtual_cut_state_def by simp
...
lemma cf_after_frontier_virtual_cut:
  ...
  unfolding cf.virtual_cut_def core_virtual_cut_state_def restrict_def
  by simp
...
lemma amb_ambig_virtual_cut:
  ...
  unfolding amb.virtual_cut_def core_virtual_cut_state_def
