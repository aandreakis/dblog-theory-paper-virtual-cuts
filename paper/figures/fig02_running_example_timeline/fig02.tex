...
every key in scope --- the cut is virtual, not physical.
That is the bootstrap cut at $c_4$. The lighter elements to the right
show the continuation beat of
...
continuation segment for the half-open interval $(c_4, c_5]$ --- strictly
after the frontier $c_4$ --- with no additional chunk read, advancing
