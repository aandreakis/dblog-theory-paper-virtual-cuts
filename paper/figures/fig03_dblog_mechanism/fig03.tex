% fig03.tex -- Set A (Architectural) Figure 3: DBLog mechanism.
%
% Top section: source-log axis with CDC events above and refresh events
% below, anchored at source-log coordinates.
% Bottom section: 7-row matrix laying out the merged raw replay with
% column-aligned (pos, kind, coord, event, status).

\centering
\begin{tikzpicture}[setA, x=1cm, y=1cm]

% ============================================================
% Source-log coordinates.
% ============================================================
\def\xCa{2.20}
\def\xCb{5.00}
\def\xCc{7.50}
...
% ============================================================
% Refresh events BELOW axis -- grouped by chunk with watermark
% brackets.
% ============================================================
\node[sublabel, anchor=east, font=\sffamily\scriptsize\itshape, text=gMid,
      align=right, inner sep=0pt]
...
% chunk A bracket (watermarked window)
...
% chunk-A reads two rows at the same coord c_1 -- stack them
% vertically so they don't compete for horizontal space.
...
% ============================================================
% Merger arrow with midway label -- single decorated descent.
% ============================================================
...
% ============================================================
% MERGED RAW REPLAY (matrix layout) -- 7 events with column-aligned
% position, kind, coord, body.  Status column flags dominated rows.
% ============================================================
\matrix[
  matrix of nodes,
  column sep=10pt,
...
\caption{The DBLog mechanism walked through the running example. Source
...
into the \emph{raw clean prefix} below --- the list the Layer~2 theorem
is stated about. A refresh row whose key is touched by a later source write
is flagged \emph{dominated}; the raw clean prefix keeps it, and an
