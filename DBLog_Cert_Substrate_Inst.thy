...
proof -
  have "virtual_cut_state b0 (clean_prefix C) (scope C) (frontier C) H"
    using vc by (simp add: virtual_cut_def core_virtual_cut_state_def virtual_cut_state_def)
  thus ?thesis
...
proof -
  ...
  hence "virtual_cut_state b0 (clean_prefix C) (scope C) (frontier C) H"
    unfolding virtual_cut_def core_virtual_cut_state_def virtual_cut_state_def .
